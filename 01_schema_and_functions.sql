...
begin
  ...
  insert into investors (id, name, father_name, address, mobile, photo, remarks, status)
  values (new_id, p->>'name', coalesce(p->>'fatherName',''), coalesce(p->>'address',''),
          p->>'mobile', coalesce(p->>'photo',''), coalesce(p->>'remarks',''), 'ACTIVE')
  returning * into rec;
...
begin
  ...
  insert into borrowers (id, name, father_name, address, mobile, photo, remarks, loan_amount, loan_date, "references", status)
  values (new_id, p->>'name', coalesce(p->>'fatherName',''), coalesce(p->>'address',''),
          p->>'mobile', coalesce(p->>'photo',''), coalesce(p->>'remarks',''),
